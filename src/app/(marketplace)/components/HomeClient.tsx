...
const HomeClient: React.FC<HomeProps> = ({ initialListings, currentUser }) => {
  ...
  `p-10 md:p-0 listingscontainer ${categoriesVisible ? 'listingscontainer--withCategories' : 'listingscontainer--collapsed'} ${topPadClass} grid max-w-screen-2xl mx-auto relative z-10 transition-[padding] duration-300 ease-out`;
