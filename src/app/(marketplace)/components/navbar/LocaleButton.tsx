...
const LocaleButton = () => {
  ...
  return (
    <button
      ...
      className="inline-flex w-full ml-[-15px] md:ml-0 items-center gap-2 rounded-2xl backdrop-blur px-3.5 py-1.5 text-sm font-medium text-neutral-700 md:shadow-md transition md:hover:shadow-lg"
    >
